...
If $X$ is a topological space, then we denote by $C(X)$ the space of continuous real-valued functions on $X$. The subspace of $C(X)$ consisting of bounded functions is denoted $C_b(X)$.
